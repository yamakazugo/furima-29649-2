...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      it 'nicknameとbirth_date,last_name,first_name,last_name_kana, first_name_kana,email、passwordとpassword_confirmationが存在すれば登録できる' do
